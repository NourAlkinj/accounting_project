...
return [
    ...
    'backup_failed_subject' => 'Gagal backups :application_name',
    ...
    'backup_successful_body' => 'Kabar baik, sebuah backups baru dari :application_name sukses dibuat pada disk bernama :disk_name.',

    'cleanup_failed_subject' => 'Membersihkan backups dari :application_name yang gagal.',
    'cleanup_failed_body' => 'Sebuah error teradi ketika membersihkan backups dari :application_name',

    'cleanup_successful_subject' => 'Sukses membersihkan backups :application_name',
    'cleanup_successful_subject_title' => 'Sukses membersihkan backups!',
    'cleanup_successful_body' => 'Pembersihan backups :application_name pada disk bernama :disk_name telah sukses.',
    ...
    'unhealthy_backup_found_not_reachable' => 'Tujuan backups tidak dapat terjangkau. :error',
    'unhealthy_backup_found_empty' => 'Tidak ada backups pada aplikasi ini sama sekali.',
    ...
    'no_backups_info' => 'Belum ada backups yang dibuat',
