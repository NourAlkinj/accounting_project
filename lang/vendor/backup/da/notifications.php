...
return [
    ...
    'backup_failed_body' => 'Vigtigt: Der skete en fejl under backups af :application_name',

    'backup_successful_subject' => 'Ny backups af :application_name oprettet',
    'backup_successful_subject_title' => 'Ny backups!',
    'backup_successful_body' => 'Gode nyheder - der blev oprettet en ny backups af :application_name på disken :disk_name.',
    ...
    'oldest_backup_date' => 'Ældste backups-størrelse',
];
