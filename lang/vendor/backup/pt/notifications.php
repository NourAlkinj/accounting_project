...
return [
    ...
    'backup_failed_body' => 'Importante: Ocorreu um erro ao executar o backups da aplicação :application_name',
    ...
    'backup_successful_body' => 'Boas notícias, foi criado um novo backups no disco :disk_name referente à aplicação :application_name.',
    ...
    'unhealthy_backup_found_old' => 'O último backups realizado em :date é demasiado antigo.',
    ...
    'disk' => 'Disco',
    'newest_backup_size' => 'Tamanho de backups mais recente',
    'number_of_backups' => 'Número de backups',
    'total_storage_used' => 'Armazenamento total usado',
    'newest_backup_date' => 'Tamanho de backups mais recente',
    'oldest_backup_date' => 'Tamanho de backups mais antigo',
];
