...
return [
    ...
    'backup_failed_subject' => 'Failed backups of :application_name',
    'backup_failed_body' => 'Important: An error occurred while backing up :application_name',

    'backup_successful_subject' => 'Successful new backups of :application_name',
    'backup_successful_subject_title' => 'Successful new backups!',
    'backup_successful_body' => 'Great news, a new backups of :application_name was successfully created on the disk named :disk_name.',
    ...
    'unhealthy_backup_found_not_reachable' => 'The backups destination cannot be reached. :error',
    'unhealthy_backup_found_empty' => 'There are no backups of this application at all.',
    'unhealthy_backup_found_old' => 'The latest backups made on :date is considered too old.',
    ...
    'disk' => 'Disk',
    'newest_backup_size' => 'Newest backups size',
    'number_of_backups' => 'Number of backups',
    'total_storage_used' => 'Total storage used',
    'newest_backup_date' => 'Newest backups date',
    'oldest_backup_date' => 'Oldest backups date',
];
