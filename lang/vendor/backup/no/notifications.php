...
return [
    ...
    'backup_successful_subject' => 'Gjennomført backups av :application_name',
    'backup_successful_subject_title' => 'Gjennomført backups!',
    'backup_successful_body' => 'Gode nyheter, en ny backups av :application_name ble opprettet på disken :disk_name.',

    'cleanup_failed_subject' => 'Opprydding av backups for :application_name feilet.',
    'cleanup_failed_body' => 'En feil oppstod under opprydding av backups for :application_name',

    'cleanup_successful_subject' => 'Opprydding av backups for :application_name gjennomført',
    'cleanup_successful_subject_title' => 'Opprydding av backups gjennomført!',
    'cleanup_successful_body' => 'Oppryddingen av backups for :application_name på disken :disk_name har blitt gjennomført.',
    ...
    'disk' => 'Disk',
    'newest_backup_size' => 'Nyeste backups-størrelse',
    'number_of_backups' => 'Antall sikkerhetskopier',
    'total_storage_used' => 'Total lagring brukt',
    'newest_backup_date' => 'Nyeste backups-størrelse',
